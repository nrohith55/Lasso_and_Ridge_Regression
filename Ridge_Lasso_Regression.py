...
# to get top 6 rows
# print (housing.head(6)) # to get top n rows use cars.head(10)
# input()
...
# print ("RMSE for LinearRegression: ",np.sqrt(np.mean((pred1-housing.MEDV)**2))) # 4.6791
# input()
...
# RMSE
# print ("RMSE for Ridge Regression: ",np.sqrt(np.mean((pred_RM1-train.MEDV)**2))) # 4.8227
# input()
...
LassoM1 = Lasso(alpha = 0.001,normalize=True)
...
# RMSE
# print ("Train RMSE - Lasso",np.sqrt(np.mean((pred_LassoM1-train.MEDV)**2))) # 4.951
# input()
